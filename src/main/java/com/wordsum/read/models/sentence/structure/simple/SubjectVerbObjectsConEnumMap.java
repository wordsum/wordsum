...
public class SubjectVerbObjectsConEnumMap {


    public enum SubjectVerbObjects_1 {
        Subject("s_node_0_leaf","NP"),
        Verb("s_node_1_leaf","VP"),
        Object_1("s_node_1_node_1_leaf","NP");
        ...
        SubjectVerbObjects_1(String leaf, String leafTag) {
            this.leaf = leaf;
