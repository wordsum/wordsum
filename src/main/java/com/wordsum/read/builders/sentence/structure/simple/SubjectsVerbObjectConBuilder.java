...
import com.wordsum.read.models.sentence.structure.simple.SubjectsVerbObjectConEnumMap;
 ...
 */
public class SubjectsVerbObjectConBuilder {

    private static Logger logger = LoggerFactory.getLogger(SubjectsVerbObjectConBuilder.class);

    /**
     * Limit access and enforce static. Do not instantiate.
     */
    protected SubjectsVerbObjectConBuilder(){}
    ...
    public static boolean hasSubjectVerbObject_1(NlpState nlpState){
        ...
        if (NlpConstituencyUtils.hasConstituency(nlpState)){
            ...
            for(SubjectsVerbObjectConEnumMap.SubjectVerbObject_1 subjectVerbObject: SubjectsVerbObjectConEnumMap.SubjectVerbObject_1.values()){
