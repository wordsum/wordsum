...
public class JazzyStateBuilderTest {
    ...
    public void testToJazzyState() throws Exception {
        ...
        JazzyState jazzyState;

        jazzyState = jazzyStateBuilder.toJazzyState("mountin");
        Assert.assertEquals(jazzyState.getText(), "mountin");
        Assert.assertTrue(jazzyState.getMisspelledWords().containsKey("mountin"));
        Assert.assertEquals(jazzyState.getMisspelledWords().get("mountin").toString(), "[mountain, mounting]");
    }
