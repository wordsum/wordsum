...
import com.wordsum.read.models.punctuation.CommaState;
import com.wordsum.read.models.punctuation.CommaStates;
...
public class CommaStateBuilderTest {
    ...
    public void testAntiComma() throws Exception {
        ...
        File testFile = FileReader.readResourceFile("/punctuationmodel/comma/CommaStateAnti.txt");
    ...
    public void testSerialComma() throws Exception {
        ...
        File testFile = FileReader.readResourceFile("/punctuationmodel/comma/CommaStateSerial.txt");
        String pattern = FileReader.readResourceToString(testFile);
