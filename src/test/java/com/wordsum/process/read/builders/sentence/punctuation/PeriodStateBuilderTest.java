...
import com.wordsum.process.read.models.sentence.punctuation.PeriodState;
...
public class PeriodStateBuilderTest {
    ...
    public void testAntiPeriod() throws Exception {
        ...
        File testFile = FileReaderUtil.readResourceFile("/punctuationmodel/period/PeriodStatesAnti.txt");
    ...
    public void testEllipsisPeriod() throws Exception {
        ...
        File testFile = FileReaderUtil.readResourceFile("/punctuationmodel/period/PeriodStatesEllipsis.txt");
        String pattern = FileReaderUtil.readFileToString(testFile);
    ...
    public void testEndPeriod() throws Exception {
        ...
        File testFile = FileReaderUtil.readResourceFile("/punctuationmodel/period/PeriodStatesEndPeriod.txt");
        String pattern = FileReaderUtil.readFileToString(testFile);
    ...
    public void testInitialPeriod() throws Exception {
        ...
        File testFile = FileReaderUtil.readResourceFile("/punctuationmodel/period/PeriodStatesInitials.txt");
        String pattern = FileReaderUtil.readFileToString(testFile);
